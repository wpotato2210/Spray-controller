#ifndef SPRAY_CONTROLLER_PINS_NANO_H
#define SPRAY_CONTROLLER_PINS_NANO_H
...
constexpr uint8_t PIN_ENCODER_CLK = 0xFFU;
constexpr uint8_t PIN_ENCODER_DT = 0xFFU;
constexpr uint8_t PIN_ENCODER_SW = 0xFFU;
constexpr uint8_t PIN_BTN_UP = 0xFFU;
constexpr uint8_t PIN_BTN_DOWN = 0xFFU;
constexpr uint8_t PIN_BTN_CAL = 0xFFU;
constexpr uint8_t PIN_BTN_SELECT = 0xFFU;
constexpr uint8_t PIN_BTN_AUTO_MANUAL = 0xFFU;
...
#endif  // SPRAY_CONTROLLER_PINS_NANO_H
